 ...
 * 3.“资源使用”：当同一根总线上只有一个DS18B20传感器时，调用tijos.runtime.sensor.ds18b20.TiDS18B20类中的<code>selectSingle</code>方法选择单个传感器,
 * 然后循环调用该类中的<code>measure</code>方法开始测量，并调用<code>getTemperature</code>方法获取温度；<br>
 * 当同一根总线上上挂有多个DIS18B20传感器时，需要先调用tijos.runtime.sensor.ds18b20.TiDS18B20类中的<code>enumeration</code>方法枚举总线上的设备,<br>
